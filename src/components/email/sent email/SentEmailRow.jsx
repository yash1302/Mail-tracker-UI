...
const SentEmailRow = ({
  ...
  return (
    ...
    >
      ...
      <td className="px-[16px] py-[12px]">
        <div className={`flex items-center gap-[4px] ${row.opens ? "text-sky-500":"text-slate-300"}`}>
          <FiEye size={12}/>
      ...
      <td className="px-[16px] py-[12px]">
        <div className={`flex items-center gap-[4px] ${row.replies ? "text-emerald-500":"text-slate-300"}`}>
      ...
      >
        ...
        <div className="flex gap-[5px]">
          ...
          <button
            onClick={()=>setSentList((sl)=>sl.filter((m)=>m.id !== row.id))}
